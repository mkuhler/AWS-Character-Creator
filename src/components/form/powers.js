...
class Powers extends React.Component {
    ...
    checkPowerArray(name, index){
      ...
      try{
        if(name == "power_name"){
          test = this.props.data.powers[index].power_name
        }else{
          test = this.props.data.powers[index].power_description.[name]
        }
                ...
                <h5>Power {i+1} </h5>
                    <Form.Row>
                        <Col xs={5}>
                            ...
                            <Form.Control type="text"
                                name="power_name"
                                arrayindex={i}
                              //  value={this.checkPowerArray("power_name", {i})}
                    ...
                    <Form.Row>
                        <Col xs={5}>
                            ...
                            <Form.Control type="text"
                              ...
                              //  value={this.checkPowerArray("power_frequency_1", {i})}
                                arrayindex={i}
                                onChange={this.props.handleChange}
                                list ="frequency"
                                />
                        ...
                        <Col xs={2}>
                            ...
                            <Form.Control type="text"
                                name="power_uses_1"
                            //    value={this.checkPowerArray("power_uses_1", {i})}
                                arrayindex={i}
                                onChange={this.props.handleChange} />
                        </Col>
                    </Form.Row>
                    ...
                    <Form.Row>
                        <Col xs={5}>
                            ...
                            <Form.Control type="select"
                                ...
                                arrayindex={i}
                            //    value={this.checkPowerArray("power_frequency_2", {i})}
                                onChange={this.props.handleChange}
                                list="frequency"/>
                        ...
                        <Col xs={2}>
                            ...
                            <Form.Control type="text"
                                name="power_uses_2"
                                arrayindex={i}
                            //    value={this.checkPowerArray("power_uses_2", {i})}
                                onChange={this.props.handleChange} />
                        </Col>
                    </Form.Row>
                     ...
                     <Form.Row>
                        <Col xs={5}>
                            ...
                            <Form.Control type="text"
                                ...
                                arrayindex={i}
                            //    value = { this.checkPowerArray("power_action_type", {i})}
                                onChange={this.props.handleChange}
                                list = "action_type" />
                        ...
                        <Col xs={5}>
                            ...
                            <Form.Control type="text"
                                name="power_range"
                            //    value = {this.checkPowerArray("power_range", {i}) }
                                arrayindex={i}
                                onChange={this.props.handleChange} />
                        </Col>
                    </Form.Row>
                    ...
                    <Form.Row>
                        <Col xs={5}>
                            ...
                            <Form.Control type="text"
                                name="power_target"
                                arrayindex={i}
                            //    value = { this.checkPowerArray("power_target", {i}) }
                                onChange={this.props.handleChange} />
                        </Col>
                        <Col xs={5}>
                            ...
                            <Form.Control type="text"
                                name="power_attack"
                            //    value = { this.checkPowerArray("power_attack", {i}) }
                                arrayindex={i}
                                onChange={this.props.handleChange} />
                        </Col>
                    </Form.Row>
                    ...
                    <Form.Row>
                        <Col xs={2}>
                            ...
                            <Form.Control type="text"
                                name="power_hit"
                            //    value = {this.checkPowerArray("power_hit", {i}) }
                                arrayindex={i}
                                onChange={this.props.handleChange} />
                        </Col>
                        <Col xs={2}>
                            ...
                            <Form.Control type="text"
                                name="power_miss"
                            //    value = {this.checkPowerArray("power_miss", {i}) }
                                arrayindex={i}
                                onChange={this.props.handleChange} />
                        </Col>
                    </Form.Row>
                    ...
                    <Form.Row>
                        <Col xs={5}>
                            ...
                            <Form.Control type="text"
                                name="power_other"
                            //    value = {this.checkPowerArray("power_other", {i}) }
                                arrayindex={i}
                                onChange={this.props.handleChange} />
                        </Col>
                     </Form.Row>
